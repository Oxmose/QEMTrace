...
do
    ...
    rm -f mini_kernel/test_pagdis_glob.S mini_kernel/test_pagen_glob.S
    touch mini_kernel/test_pagdis_glob.S
    touch mini_kernel/test_pagen_glob.S

    cat "$entry" >> mini_kernel/test_pagdis_glob.S
